...
This file consolidates rules repeatedly validated across real web, mobile, backend, realtime, AI and operations projects. It excludes product-specific business behavior and keeps the patterns that prevented bugs, saved tokens, improved QA or clarified production handoff.
...
This baseline becomes framework modules only through repetition:
